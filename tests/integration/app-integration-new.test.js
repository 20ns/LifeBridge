...
// We will rely on the global fetch mock from jest.setup.js
// const fetch = require('node-fetch'); // Removed: global.fetch is already mocked

describe('LifeBridge Integration Tests', () => {
  const baseUrl = 'http://localhost:3001/dev';
  
  // Mock fetch for testing without running server
  // jest.mock('node-fetch', () => jest.fn()); // Removed: global.fetch is already mocked
